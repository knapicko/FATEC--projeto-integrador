          ...
          children: [
            ...
            _CampoTexto(
              ...
              prefixWidget: SeletorDDI(
                ...
                corPrimaria: const Color(0xFF0FB3FF),
                onChanged: (ddi) {
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return CheckboxListTile(
                            ...
                            activeColor: const Color(0xFF0FB3FF),
                            onChanged: (checked) {
                              setState(() {
                                if (checked == true) {
...
class _CompletarCadastroProfissionalDocumentosPageState
  ...
  Widget _botaoDocumento({
    ...
    final cor = concluido ? const Color(0xFF2EAD5B) : const Color(0xFF0FB3FF);
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: suffixIcon != null
              ? Icon(suffixIcon, color: const Color(0xFF0FB3FF))
              : null,
          filled: true,
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: Color(0xFF0FB3FF), width: 1.5),
          ),
        ),
      ),
    );
